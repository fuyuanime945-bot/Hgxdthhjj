        ...
        try:
            ...
            if isinstance(
                ...
                if retry:
                    ...
                    print(
                        f"Rate limited. Waiting {retry}s"
                    )
...
def send_files(
    ...
    if failed:
        ...
        send(
            chat_id,
            f"""
✅ <b>{sent}</b> File ပို့ပြီးပါပြီ
❌ <b>{failed}</b> File ပို့မရပါ
""",
            parse_mode="HTML"
        )
